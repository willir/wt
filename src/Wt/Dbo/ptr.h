...
public:
  ...
  bool insertedInTransaction() const
    { return 0 != (state_ & InsertedInTransaction); }
  ...
  void setInsertedInTransaction() { state_ |= InsertedInTransaction; }
